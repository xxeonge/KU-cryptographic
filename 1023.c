...
// 	tmp1.dat[0] = tmp1.dat[1] = tmp1.data[2] = tmp1.data[7] = tmp2.dat[3] = tmp2.dat[4] = tmp2.data[5] = 0;
// 	tmp1.dat[3] = in.dat[12];
// 	tmp1.dat[4] = in.dat[13];
// 	tmp1.dat[5] = tmp2.dat[6] = in.dat[14];
// 	tmp1.dat[6] = tmp2.dat[7]= in.dat[15];

// 	tmp2.len=8;

// 	while((tmp2.len > 0) && (tmp2.dat[tmp2.len -1] == 0)) tmp2.len--;

// 	ECC_bn_add_mod(&tmp1, &tmp2, &in, &prime_p256);
...
// 	tmp1.dat[3] = tmp1.dat[4] = tmp1.dat[5] = 0;
// 	tmp1.dat[0] = tmp2.dat[7] = in.dat[8];
// 	tmp1.dat[1] = tmp2.dat[0] = in.dat[9];
// 	tmp1.dat[2] = tmp2.dat[1] = in.dat[10];
// 	tmp1.dat[6] = tmp2.dat[4] = in.dat[14];
// 	tmp1.dat[7] = tmp2.dat[5] = in.dat[15];
...
// 	tmp2.dat[3] = tmp2.dat[4] = tmp2.dat[5];
// 	tmp1.dat[0] = in.dat[9];
// 	tmp1.dat[1] = tmp2.dat[7] = in.dat[10];
// 	tmp1.dat[2] = tmp2.dat[0] = in.dat[11];
// 	tmp1.dat[3] = tmp1.dat[6] = tmp2.dat[2] = in.dat[13];
// 	tmp1.dat[4] = in.dat[14];
// 	tmp1.dat[7] = tmp2.dat[6] = in.dat[8];
...
// 	tmp2.dat[4] = tmp2.data[5] = 0;
// 	tmp2.dat[0] = tmp2.dat[12];
// 	tmp2.dat[1] = tmp2.dat[13]; 
// 	tmp2.dat[2] = tmp2.dat[14];
// 	tmp2.dat[3] = tmp2.dat[15];
// 	tmp2.dat[5] = tmp2.dat[9];	
// 	tmp2.dat[5] = tmp2.dat[9];
// }
